...
@app.route('/modelDash')
def modelDash():
    with open('report_test.txt', 'r') as file_test:
        content_test = file_test.read()

    with open('report_train.txt', 'r') as file_train:
        content_train = file_train.read()

    return render_template("modelDash.html", content_test=content_test, content_train=content_train)
